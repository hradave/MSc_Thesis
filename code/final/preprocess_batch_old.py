...
for folder in os.listdir(os.path.join(base_path, "dataset")):
    # folder can be GBM or LGG
    for id in os.listdir(os.path.join(base_path, "dataset", folder)):
        for file_name in os.listdir(os.path.join(base_path,'dataset',folder,id)):
            if file_name.endswith('.svs'):
                print(counter)
                counter += 1
                path = os.path.join(base_path, 'dataset', folder, id, file_name)
                print(path)
                ...
                for patch_size in patch_sizes:
                    ...
                    patches_path = os.path.join(base_path, 'patches', patch_sizes[patch_size])
                    if folder == "LGG":
