...
for folder in os.listdir(os.path.join(base_path, "dataset_extra_test_lnx00191")):
    # folder can be GBM or LGG
    for id in os.listdir(os.path.join(base_path, "dataset_extra_test_lnx00191", folder)):
        for file_name in os.listdir(os.path.join(base_path,'dataset_extra_test_lnx00191',folder,id)):
            if file_name.endswith('.svs'):
                print(counter)
                counter += 1
                path = os.path.join(base_path, 'dataset_extra_test_lnx00191', folder, id, file_name)
                print(path)
