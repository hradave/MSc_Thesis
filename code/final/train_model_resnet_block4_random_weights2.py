...
### Build model
baseModel = tf.keras.applications.ResNet50(weights=None, include_top=False, input_tensor=Input(shape=(224, 224, 3)))
...
headModel = baseModel.layers[142].output

headModel = tf.keras.layers.AveragePooling2D(pool_size=(14, 14))(headModel)
headModel = tf.keras.layers.Flatten(name="flatten")(headModel)
headModel = tf.keras.layers.Dropout(0.5)(headModel, training = True)
headModel = tf.keras.layers.Dense(200, activation="relu")(headModel)
headModel = tf.keras.layers.Dropout(0.5)(headModel, training = True)
