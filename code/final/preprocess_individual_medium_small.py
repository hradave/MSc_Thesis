...
for patch_size in patch_sizes:
    ...
    patch_stat = patch_image(rgb = whole_slide_image, pxl = int(patch_size), file_name = file_name, patches_path = patches_path, target_image = target_image, normalizer = normalizer)
    end_patching = timer()
